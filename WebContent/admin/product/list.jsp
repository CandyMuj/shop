...
<HTML>
								...
								<tr
									...
									<s:iterator var="p" value="pageBean.list" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="17%">
												<img width="45" height="50" src="${pageContext.request.contextPath }/<s:property value="#p.image"/>" class="demo1" />
											</td>
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="17%">
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="product_edit.action?pid=${pid}">
													<img src="images/i_edit.gif" border="0" style="CURSOR: hand">
												</a>
											</td>
											
											<td align="center" style="HEIGHT: 22px">
												<a class="delete" data-id="${pid}">
													<img src="images/i_del.gif" width="16" height="16" border="0" style="CURSOR: hand" class="demo2">
												</a>
											</td>
										</tr>
									</s:iterator>	
	...
	<script type="text/javascript">
		...
		function deleteProduct(){
			...
			$(".delete").bind("click",function(){
				...
				swal({
                	...
                	$.get("product_delete.action?",{'pid':pid});
                    setTimeout(function(){
                    	location.reload();
                    })
                });
		...
		/* function del() {
			var pid = $(".delete").attr("data-id");
			alert(pid);
			$.get("${pageContext.request.contextPath}/product_delete.action?",{'pid':pid});
		}	 */
